...
void Main()
{
	...
	Texture texture(L"Example/Windmill.png"), texture2(L"Example/siv3d-kun.png");

	Array<InlineFrame> frames;
	frames.push_back(InlineFrame(Rect(20, 20, 100, 100)));
	frames.push_back(InlineFrame(Rect(160, 20, 120, 200)));
	frames.push_back(InlineFrame(Rect(320, 20, 140, 300)));
	frames.push_back(InlineFrame(Rect(500, 20, 160, 400)));
	frames.push_back(InlineFrame(Rect(700, 20, 480, 400)));
	frames.push_back(InlineFrame(Rect(20, 260, 260, 160)));
	frames.push_back(InlineFrame(Rect(20, 460, 480, 200)));
